import random, math, pylab, mpl_toolkits.mplot3d, numpy, os, datetime
...
print 'omega: ', omega
positions = {}
filename = 'boson_configuration_c1.txt'
...
if os.path.isfile(filename):
    ...
    f.close()
    if len(positions) != N:
        print len(positions), '!=', N
        raise Exception('error input file')
