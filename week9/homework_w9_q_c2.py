...
N = 20
seed = 'brian'   # 12345 'hello' 'parrot' 'brian'
random.seed(seed)
...
pylab.title(str(best_energy) + ', seed = ' + str(seed) + ', N = ' + str(N))
pylab.axis('scaled')
pylab.axis([0.0, 1.0, 0.0, 1.0])
pylab.savefig('simulated_annealing_best_path_N%i_seed_%s.png' % (N, seed))
pylab.show()
